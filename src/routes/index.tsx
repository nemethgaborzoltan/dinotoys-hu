...
function Home() {
  ...
  return <>
    <section className="hero container-wide"><div className="hero-copy"><span className="pill">✨ Friss trendek hetente</span><h1>Nem még egy játékwebshop.<br/><span>Találd meg gyorsan azt, aminek örülni fog.</span></h1><p>Válogatott trendtermékek, ismert márkák, okos ajándékkeresés és egy modern vásárlási élmény — felesleges kattintgatás nélkül.</p><div className="hero-actions"><Link to="/termekek" search={{}} className="btn btn-primary btn-large">Felfedezem a játékokat →</Link><Link to="/ai-ajandekkereso" className="btn btn-ghost btn-large">✨ Segíts ajándékot választani</Link></div><div className="hero-trust"><span>✓ Magyar ügyfélszolgálat</span><span>✓ Biztonságos fizetés</span><span>✓ 14 napos jogszabályi elállás</span></div></div><div className="hero-visual"><div className="hero-card hero-card-main"><img src={products[0].art} alt={products[0].name}/><div><span>Most pörög</span><b>{products[0].name}</b></div></div><div className="hero-float top">🔥 1 000+ termékforrásra tervezve</div><div className="hero-float bottom">⭐ 4.8/5 demo értékelés</div></div></section>
